...
FunctionsToExport = 'a', 'address', 'area', 'article', 'aside', 'base', 'blockquote', 'body', 'br', 
               ...
               'ol', 'optgroup', 'option', 'output', 'p', 'pre', 'progress', 'script', 'section', 
               'selecttag', 'small', 'strong', 'style', 'sub', 'sup', 'table', 'tbody', 'td', 
               'textarea', 'tfoot', 'th', 'thead', 'title', 'tr', 'ul', 'Write-PSHTMLAsset', 
               'Write-PSHTMLSymbol'
