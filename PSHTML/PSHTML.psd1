...
FunctionsToExport = 'a', 'address', 'area', 'article', 'aside', 'b', 'base', 'blockquote', 'body', 'br', 
               ...
               'Get-PSHTMLInclude', 'Get-pshtmlOutputPreference', 'h1', 'h2', 'h3', 'h4', 
               'h5', 'h6', 'head', 'Header', 'hr', 'html', 'i', 'img', 'input', 
               ...
               'New-PSHTMLChartPolarAreaDataSet', 'New-PSHTMLChartRadarDataSet', 
