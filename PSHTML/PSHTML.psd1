...
FunctionsToExport = 'a', 'address', 'area', 'article', 'aside', 'base', 'blockquote', 'body', 'br', 
               ...
               'Get-PSHTMLConfiguration', 'Get-PSHTMLInclude', 'h1', 'h2', 'h3', 'h4', 'h5', 
               ...
               'New-PSHTMLChartPieDataSet', 'noscript', 'ol', 'optgroup', 'option', 
               'output', 'p', 'pre', 'progress', 'script', 'section', 'selecttag', 'small', 
               'span', 'strong', 'style', 'sub', 'sup', 'table', 'tbody', 'td', 'textarea', 
               'tfoot', 'th', 'thead', 'title', 'tr', 'ul', 'Write-PSHTMLAsset', 
               'Write-PSHTMLInclude', 'Write-PSHTMLSymbol'
