...
FunctionsToExport = 'a', 'Add-PSHTMLAsset', 'address', 'area', 'article', 'aside', 'base', 
               'blockquote', 'body', 'br', 'button', 'canvas', 'caption', 'Clear-WhiteSpace', 
               'col', 'colgroup', 'ConvertTo-HtmlTable', 'datalist', 'dd', 'div', 'dl', 'dt', 
               'em', 'fieldset', 'figcaption', 'figure', 'footer', 'Form', 
               'Get-PSHTMLAssets', 'Get-PSHTMLConfiguration', 'h1', 'h2', 'h3', 'h4', 'h5', 
               'h6', 'head', 'Header', 'hr', 'html', 'img', 'input', 
               'Install-PSHTMLVSCodeSnippets', 'keygen', 'label', 'legend', 'li', 'link', 
               'map', 'math', 'meta', 'meter', 'nav', 'noscript', 'ol', 'optgroup', 'option', 
               'output', 'p', 'pre', 'progress', 'script', 'section', 'selecttag', 'small', 
               'strong', 'style', 'sub', 'sup', 'table', 'tbody', 'td', 'textarea', 'tfoot', 'th', 
               'thead', 'title', 'tr', 'ul', 'Write-PSHTMLSymbol'
